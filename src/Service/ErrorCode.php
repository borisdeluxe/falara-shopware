...
enum ErrorCode: string
{
    ...
    case CONNECTION_DISCONNECTED = 'CONNECTION_DISCONNECTED';
    case WRITEBACK_FAILED       = 'WRITEBACK_FAILED';
    case IMPORT_EXCEPTION       = 'IMPORT_EXCEPTION';
    ...
    public function message(): string
    {
        return match ($this) {
            ...
            self::CONNECTION_DISCONNECTED => 'The connection was disconnected while the job was in flight.',
            self::WRITEBACK_FAILED       => 'Write-back failed. Check logs for details.',
            self::IMPORT_EXCEPTION       => 'An exception occurred during import. Check logs for details.',
        };
    }
}
