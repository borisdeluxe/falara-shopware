const{Application:f}=Shopware;class y{constructor(t,a){this.httpClient=t,this.loginService=a,this.basePath="_action/falara"}getHeaders(){return{Authorization:`Bearer ${this.loginService.getToken()}`,"Content-Type":"application/json"}}connect(t,a){return this.httpClient.post(`${this.basePath}/connect`,{salesChannelId:t,apiKey:a},{headers:this.getHeaders()})}disconnect(t){return this.httpClient.post(`${this.basePath}/disconnect`,{salesChannelId:t},{headers:this.getHeaders()})}getConnection(t){return this.httpClient.get(`${this.basePath}/connection/${t}`,{headers:this.getHeaders()})}getUsage(t){return this.httpClient.get(`${this.basePath}/settings/usage/${t}`,{headers:this.getHeaders()})}getContentItems(t,a,s={}){return this.httpClient.get(`${this.basePath}/content/${t}/${a}`,{params:s,headers:this.getHeaders()})}getContentTypes(){return this.httpClient.get(`${this.basePath}/content-types`,{headers:this.getHeaders()})}getSnippetSubgroups(t,a){return this.httpClient.get(`${this.basePath}/snippet-subgroups/${t}`,{params:{group:a},headers:this.getHeaders()})}getSnippetGroups(t){return this.httpClient.get(`${this.basePath}/snippet-groups/${t}`,{headers:this.getHeaders()})}translate(t){return this.httpClient.post(`${this.basePath}/translate`,t,{headers:this.getHeaders()})}getJobs(t,a={}){return this.httpClient.get(`${this.basePath}/jobs/${t}`,{params:a,headers:this.getHeaders()})}getJob(t){return this.httpClient.get(`${this.basePath}/jobs/detail/${t}`,{headers:this.getHeaders()})}retryWriteBack(t){return this.httpClient.post(`${this.basePath}/jobs/${t}/retry`,{},{headers:this.getHeaders()})}archiveJob(t){return this.httpClient.patch(`${this.basePath}/jobs/${t}/archive`,{},{headers:this.getHeaders()})}runAudit(t){return this.httpClient.get(`${this.basePath}/audit/${t}`,{headers:this.getHeaders()})}getDefaults(t){return this.httpClient.get(`${this.basePath}/settings/defaults/${t}`,{headers:this.getHeaders()})}saveDefaults(t,a){return this.httpClient.post(`${this.basePath}/settings/defaults/${t}`,a,{headers:this.getHeaders()})}getGlossaries(t){return this.httpClient.get(`${this.basePath}/settings/glossaries/${t}`,{headers:this.getHeaders()})}getCustomFields(t){return this.httpClient.get(`${this.basePath}/settings/custom-fields/${t}`,{headers:this.getHeaders()})}addCustomField(t,a,s){return this.httpClient.post(`${this.basePath}/settings/custom-fields/${t}`,{fieldSetName:a,fieldName:s},{headers:this.getHeaders()})}deleteCustomField(t){return this.httpClient.delete(`${this.basePath}/settings/custom-fields/entry/${t}`,{headers:this.getHeaders()})}getAvailableCustomFields(t){return this.httpClient.get(`${this.basePath}/settings/available-custom-fields/${t}`,{headers:this.getHeaders()})}}f.addServiceProvider("falaraApiService",e=>{const t=f.getContainer("init");return new y(t.httpClient,e.loginService)});const v="modulepreload",S=function(e){return window.__sw__.assetPath+"/bundles/falaratranslationmanager/administration/"+e},h={},g=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){let i=function(o){return Promise.all(o.map(d=>Promise.resolve(d).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),p=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));r=i(a.map(o=>{if(o=S(o),o in h)return;h[o]=!0;const d=o.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${u}`))return;const c=document.createElement("link");if(c.rel=d?"stylesheet":v,d||(c.as="script"),c.crossOrigin="",c.href=o,p&&c.setAttribute("nonce",p),document.head.appendChild(c),d)return new Promise((m,b)=>{c.addEventListener("load",m),c.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${o}`)))})}))}function l(i){const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i}return r.then(i=>{for(const n of i||[])n.status==="rejected"&&l(n.reason);return t().catch(l)})},{Component:x}=Shopware;x.register("falara-dashboard",{template:`
    ...
    `,props:{usage:{type:Object,required:!0,default:()=>({plan:"",used:0,limit:0})}},computed:{progressValue(){return!this.usage.limit||this.usage.limit===0?0:Math.min(Math.round(this.usage.used/this.usage.limit*100),100)},isWarning(){return this.progressValue>=80&&this.progressValue<100},isExceeded(){return this.progressValue>=100},remaining(){const e=(this.usage.limit||0)-(this.usage.used||0);return Math.max(e,0)}}});const{Component:j}=Shopware;j.register("falara-translate-modal",{template:`
...
//# sourceMappingURL=falara-translation-manager-DtjzEaGj.js.map
