const{Application:u}=Shopware;class y{constructor(a,e){this.httpClient=a,this.loginService=e,this.basePath="_action/falara"}getHeaders(){return{Authorization:`Bearer ${this.loginService.getToken()}`,"Content-Type":"application/json"}}connect(a,e){return this.httpClient.post(`${this.basePath}/connect`,{salesChannelId:a,apiKey:e},{headers:this.getHeaders()})}disconnect(a){return this.httpClient.post(`${this.basePath}/disconnect`,{salesChannelId:a},{headers:this.getHeaders()})}getConnection(a){return this.httpClient.get(`${this.basePath}/connection/${a}`,{headers:this.getHeaders()})}getUsage(a){return this.httpClient.get(`${this.basePath}/settings/usage/${a}`,{headers:this.getHeaders()})}getContentItems(a,e,s={}){return this.httpClient.get(`${this.basePath}/content/${a}/${e}`,{params:s,headers:this.getHeaders()})}getContentTypes(){return this.httpClient.get(`${this.basePath}/content-types`,{headers:this.getHeaders()})}getSnippetGroups(a){return this.httpClient.get(`${this.basePath}/content/${a}/snippet/groups`,{headers:this.getHeaders()})}translate(a){return this.httpClient.post(`${this.basePath}/translate`,a,{headers:this.getHeaders()})}getJobs(a,e={}){return this.httpClient.get(`${this.basePath}/jobs/${a}`,{params:e,headers:this.getHeaders()})}getJob(a){return this.httpClient.get(`${this.basePath}/jobs/detail/${a}`,{headers:this.getHeaders()})}retryWriteBack(a){return this.httpClient.post(`${this.basePath}/jobs/${a}/retry`,{},{headers:this.getHeaders()})}archiveJob(a){return this.httpClient.patch(`${this.basePath}/jobs/${a}/archive`,{},{headers:this.getHeaders()})}runAudit(a){return this.httpClient.get(`${this.basePath}/audit/${a}`,{headers:this.getHeaders()})}getDefaults(a){return this.httpClient.get(`${this.basePath}/settings/defaults/${a}`,{headers:this.getHeaders()})}saveDefaults(a,e){return this.httpClient.post(`${this.basePath}/settings/defaults/${a}`,e,{headers:this.getHeaders()})}getGlossaries(a){return this.httpClient.get(`${this.basePath}/settings/glossaries/${a}`,{headers:this.getHeaders()})}getCustomFields(a){return this.httpClient.get(`${this.basePath}/settings/custom-fields/${a}`,{headers:this.getHeaders()})}addCustomField(a,e,s){return this.httpClient.post(`${this.basePath}/settings/custom-fields/${a}`,{fieldSetName:e,fieldName:s},{headers:this.getHeaders()})}deleteCustomField(a){return this.httpClient.delete(`${this.basePath}/settings/custom-fields/entry/${a}`,{headers:this.getHeaders()})}}u.addServiceProvider("falaraApiService",t=>{const a=u.getContainer("init");return new y(a.httpClient,t.loginService)});const v="modulepreload",S=function(t){return window.__sw__.assetPath+"/bundles/falaratranslationmanager/administration/"+t},h={},g=function(a,e,s){let n=Promise.resolve();if(e&&e.length>0){let r=function(l){return Promise.all(l.map(c=>Promise.resolve(c).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),f=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));n=r(e.map(l=>{if(l=S(l),l in h)return;h[l]=!0;const c=l.endsWith(".css"),p=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${p}`))return;const d=document.createElement("link");if(d.rel=c?"stylesheet":v,c||(d.as="script"),d.crossOrigin="",d.href=l,f&&d.setAttribute("nonce",f),document.head.appendChild(d),c)return new Promise((m,b)=>{d.addEventListener("load",m),d.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return n.then(r=>{for(const i of r||[])i.status==="rejected"&&o(i.reason);return a().catch(o)})},{Component:x}=Shopware;x.register("falara-dashboard",{template:`
    ...
    `,data(){return{isScanning:!1,results:null,salesChannelId:null}},created(){this.initSalesChannel()},methods:{async initSalesChannel(){const a=await Shopware.Service("repositoryFactory").create("sales_channel").search(new Shopware.Data.Criteria,Shopware.Context.api);a.length>0&&(this.salesChannelId=a.first().id)},async runScan(){if(this.salesChannelId){this.isScanning=!0,this.results=null;try{const a=await Shopware.Service("falaraApiService").runAudit(this.salesChannelId);this.results=a.data||{}}catch{Shopware.State.dispatch("notification/createNotification",{type:"error",message:this.$t("falara-translation-manager.general.error")})}finally{this.isScanning=!1}}},coveragePercent(t){if(!t.total||t.total===0)return 100;const a=t.total-(t.missing||0);return Math.round(a/t.total*100)}}});const{Component:j}=Shopware;j.register("falara-settings",{template:`
        <div>
            <falara-nav-tabs />
    ...
    `,props:{usage:{type:Object,required:!0,default:()=>({plan:"",used:0,limit:0})}},computed:{progressValue(){return!this.usage.limit||this.usage.limit===0?0:Math.min(Math.round(this.usage.used/this.usage.limit*100),100)},isWarning(){return this.progressValue>=80&&this.progressValue<100},isExceeded(){return this.progressValue>=100},remaining(){const t=(this.usage.limit||0)-(this.usage.used||0);return Math.max(t,0)}}});const{Component:A}=Shopware;A.register("falara-translate-modal",{template:`
