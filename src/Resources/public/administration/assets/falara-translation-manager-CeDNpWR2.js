const{Application:f}=Shopware;class v{constructor(t,e,n="_action/falara"){this.httpClient=t,this.loginService=e,this.basePath=n,this.name="falaraApiService"}getHeaders(){return{Authorization:`Bearer ${this.loginService.getToken()}`,"Content-Type":"application/json"}}connect(t,e){return this.httpClient.post(`${this.basePath}/connection/connect`,{salesChannelId:t,apiKey:e},{headers:this.getHeaders()})}disconnect(t){return this.httpClient.post(`${this.basePath}/connection/disconnect`,{salesChannelId:t},{headers:this.getHeaders()})}getConnection(t){return this.httpClient.get(`${this.basePath}/connection/${t}`,{headers:this.getHeaders()})}getUsage(t){return this.httpClient.get(`${this.basePath}/connection/${t}/usage`,{headers:this.getHeaders()})}getContentItems(t,e,n={}){const s=new URLSearchParams({salesChannelId:t,type:e,...n}).toString();return this.httpClient.get(`${this.basePath}/content?${s}`,{headers:this.getHeaders()})}translate(t){return this.httpClient.post(`${this.basePath}/translate`,t,{headers:this.getHeaders()})}getJobs(t,e={}){const n=new URLSearchParams({salesChannelId:t,...e}).toString();return this.httpClient.get(`${this.basePath}/jobs?${n}`,{headers:this.getHeaders()})}getJob(t){return this.httpClient.get(`${this.basePath}/jobs/${t}`,{headers:this.getHeaders()})}retryWriteBack(t){return this.httpClient.post(`${this.basePath}/jobs/${t}/retry-writeback`,{},{headers:this.getHeaders()})}archiveJob(t){return this.httpClient.post(`${this.basePath}/jobs/${t}/archive`,{},{headers:this.getHeaders()})}runAudit(t){return this.httpClient.post(`${this.basePath}/audit`,{salesChannelId:t},{headers:this.getHeaders()})}getDefaults(t){return this.httpClient.get(`${this.basePath}/settings/${t}/defaults`,{headers:this.getHeaders()})}saveDefaults(t,e){return this.httpClient.post(`${this.basePath}/settings/${t}/defaults`,e,{headers:this.getHeaders()})}getGlossaries(t){return this.httpClient.get(`${this.basePath}/settings/${t}/glossaries`,{headers:this.getHeaders()})}getCustomFields(t){return this.httpClient.get(`${this.basePath}/settings/${t}/custom-fields`,{headers:this.getHeaders()})}saveCustomFields(t,e){return this.httpClient.post(`${this.basePath}/settings/${t}/custom-fields`,{fields:e},{headers:this.getHeaders()})}}f.addServiceProvider("falaraApiService",a=>{const t=f.getContainer("init");return new v(t.httpClient,a.loginService)});const _="modulepreload",y=function(a){return window.__sw__.assetPath+"/bundles/falaratranslationmanager/administration/"+a},m={},u=function(t,e,n){let s=Promise.resolve();if(e&&e.length>0){let r=function(l){return Promise.all(l.map(c=>Promise.resolve(c).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),g=(i==null?void 0:i.nonce)||(i==null?void 0:i.getAttribute("nonce"));s=r(e.map(l=>{if(l=y(l),l in m)return;m[l]=!0;const c=l.endsWith(".css"),h=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${h}`))return;const d=document.createElement("link");if(d.rel=c?"stylesheet":_,c||(d.as="script"),d.crossOrigin="",d.href=l,g&&d.setAttribute("nonce",g),document.head.appendChild(d),c)return new Promise((p,b)=>{d.addEventListener("load",p),d.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(r){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=r,window.dispatchEvent(i),!i.defaultPrevented)throw r}return s.then(r=>{for(const i of r||[])i.status==="rejected"&&o(i.reason);return t().catch(o)})},{Component:w}=Shopware;w.register("falara-dashboard",{template:`
    ...
    `,props:{usage:{type:Object,required:!0,default:()=>({plan:"",used:0,limit:0})}},computed:{progressValue(){return!this.usage.limit||this.usage.limit===0?0:Math.min(Math.round(this.usage.used/this.usage.limit*100),100)},isWarning(){return this.progressValue>=80&&this.progressValue<100},isExceeded(){return this.progressValue>=100},remaining(){const a=(this.usage.limit||0)-(this.usage.used||0);return Math.max(a,0)}}});const{Component:k}=Shopware;k.register("falara-translate-modal",{template:`
